...
<nav
	class="sticky top-0 z-50 w-full border-b border-white/10 bg-zinc-950/50 backdrop-blur-xl transition-all duration-300 pt-[env(safe-area-inset-top,0px)]"
>
	<div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
		<div class="flex h-16 items-center justify-between">
			...
			>
				...
				<span
					class="silver-float silver-backlight bg-linear-to-r from-zinc-100 via-slate-200 via-45% to-zinc-400 bg-clip-text text-transparent tracking-wide drop-shadow-[0_2px_3px_rgba(0,0,0,0.55)] [text-shadow:0_0_6px_rgba(255,255,255,0.18)] hover:brightness-110 hover:[text-shadow:0_0_9px_rgba(255,255,255,0.24)]"
				>
					ykc2486's Toolbox
				</span>
			</a>
	...
	{#if isMenuOpen}
		<div
			class="border-t border-white/10 bg-zinc-950/85 backdrop-blur-xl"
